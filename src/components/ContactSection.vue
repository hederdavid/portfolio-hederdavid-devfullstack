...
<template>
  <section
    class="bg-[#0F1A2F] text-white lg:flex-row lg:px-12 lg:py-12 flex flex-col justify-center items-center p-6 gap-6 text-center rounded-2xl max-w-4xl mx-auto w-full"
  >
    <h3 class="font-bold text-2xl">Dê vida ao seu projeto</h3>
